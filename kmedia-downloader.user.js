...
(function () {
    ...
    // =========================================================
    const KPOP_DATABASE = {
    "(G)I-DLE": ["Miyeon", "Minnie", "Soojin", "Soyeon", "Yuqi", "Shuhua"],
    "15&": ["Yerin", "Jamie"],
    "1PS": ["Suhyeon"],
    "2EYES": ["Hyangsuk", "Hyerin", "Dasom", "Daeun"],
    "2NE1": ["Bom", "Dara", "CL", "Minzy"],
    "3YE": ["Yurim", "Yuji", "Haeun"],
    "4minute": ["Jihyun", "Gayoon", "Jiyoon", "HyunA", "Sohyun"],
    "4TEN": ["Hyeji", "Heeo", "Yoon", "Hyejin"],
    "9Muses": ["Hyuna", "Euaerin", "Sungah", "Kyungri", "Hyemi", "Minha", "Sojin", "Keumjo"],
    "ADYA": ["Yeonsu", "Seowon", "Sena", "Chaeeun", "Seungchae"],
    "aespa": ["Karina", "Giselle", "Winter", "Ningning"],
    "After School": ["Kahi", "Jungah", "Jooyeon", "Uee", "Raina", "Bekah", "Nana", "Lizzy", "E-Young", "Kaeun", "Soyoung"],
    "ALICE": ["EJ", "Do-A", "Chaejeong", "Yeonje", "Yukyung", "Sohee", "Karin"],
    "ANS": ["Lina", "J", "Royeon", "Dalyn", "Raon", "Bian", "Dami", "Haena"],
    "AOA BLACK": ["Choa", "Yookyung", "Mina"],
    "AoA": ["Choa", "Jimin", "Yuna", "Hyejeong", "Seolhyun", "Chanmi"],
    "AOA": ["Mina"],
    "Apink": ["Chorong", "Bomi", "Eunji", "Naeun", "Namjoo", "Hayoung"],
    "Apple.B": ["Yurim", "Yuji", "Haeun"],
    "APRIL": ["Chaekyung", "Chaewon", "Hyunjoo", "Naeun", "Yena", "Rachel", "Jinsol"],
    "April": ["Somin"],
    "AREAL": ["Hyebin", "Areum", "Segye", "Dabi"],
    "ARIAZ": ["Yunji", "Dawon", "Sihyeon", "Yeori", "Hyogyeong", "Jueun"],
    "ARTBEAT": ["Yubin", "Seyoung", "Yoojin", "Damhee", "Gaeun", "Sieun", "Haeun"],
    "ARTMS": ["JinSoul", "Haseul", "Kim Lip", "Heejin", "Choerry"],
    "BABYMONSTER": ["Ruka", "Pharita", "Asa", "Ahyeon", "Haram", "Rora", "Chiquita"],
    "BADKIZ": ["Monika", "LuA", "K.Me", "Somin", "U-Si"],
    "BADVILLAIN": ["Emma", "Chloe Young", "Hu'e", "Ina", "Yunseo", "Vin", "Kelly"],
    "Berry Good": ["Taeha", "Johyun", "Seoyul", "Daye", "Sehyung", "Gowoon"],
    "BESTie": ["Hyeyeon", "Uji", "Dahye", "Haeryeong"],
    "Billlie": ["Moon Sua", "Suhyeon", "Haram", "Tsuki", "Sheon", "Siyoon", "Haruna"],
    "BLACKPINK": ["Jisoo", "Jennie", "Rosé", "Lisa"],
    "Blackswan": ["Youngheun", "Fatou", "Judy", "Nvee", "Leia", "Gabi", "Sriya"],
    "Blady": ["Gabin", "Dayoung", "Giru", "Tina", "Yeeun"],
    "Bling Bling": ["Juhyun", "Ayamy", "Jieun", "Marin", "Narin", "Yubin"],
    "Bolbbalgan4": ["Jiyoung", "Jiyoon"],
    "Bonus Baby": ["Moonhee", "Hayoon", "Chaehyun", "Dayun", "Gaon", "Kongyoo"],
    "BOTOPASS": ["Seoyoon", "Sang", "Jiwon", "Ria", "Mihee", "Harin", "Shiho", "Ahyoon"],
    "Brave Girls": ["Minyoung", "Yujeong", "Eunji", "Yoojin", "Yuna", "Hyeran", "Hayun"],
    "Brown Eyed Girls": ["Jea", "Miryo", "Narsha", "Gain"],
    "bugAboo": ["Eunchae", "Yoona", "Rainie", "Cyan", "Choyeon", "Zin"],
    "Busters": ["Minji", "Hyungseo", "Jisoo", "Minjung", "Chaeyeon", "Yeseo"],
    "BVNDIT": ["Yiyeon", "Songhee", "Jungwoo", "Simyeong", "Seungeun"],
    "Candy Shop": ["Soram", "Yuina", "Sui", "Sarang"],
    "CHECKMATE": ["Sieun", "Suri"],
    "Cherry Bullet": ["Haeyoon", "Yuju", "Ella", "Bora", "Jiwon", "Kokoro", "Remi", "Chaerin", "Lin Lin", "May"],
    "Cignature": ["Chaesol", "Jeewon", "Yeah", "Sunn", "Seline", "Chloe", "Belle", "Semi", "Dohee"],
    "CLASS:y": ["Hyungseo", "Chaewon", "Hyeju", "Riwon", "Jimin", "Boeun", "Seonyu"],
    "CLC": ["Seunghee", "Yujin", "Seungyeon", "Sorn", "YeeEun", "Elkie", "Eunbin"],
    "Clear:I": ["Sang"],
    "CRAXY": ["Woo-ah", "Karin", "Hyejin", "Swan", "ChaeY"],
    "Crayon Pop": ["Geummi", "Ellin", "Choa", "Way", "Soyul"],
    "CSR": ["Geumhee", "Sihyeon", "Seoyeon", "Yuna", "Duna", "Sua", "Yeham"],
    "D-Unit": ["Yujin"],
    "Dal Shabet": ["Viki", "Serri", "Ahyoung", "Jiyul", "Woohee", "Gaeun", "Subin"],
    "Davichi": ["Haeri", "Minkyung"],
    "DIA": ["Eunice", "Huihyeon", "Jueun", "Jenny", "Yebin", "Eunjin", "Chaeyeon", "Eunchae", "Somyi"],
    "Dreamcatcher": ["Jiu", "Sua", "Siyeon", "Handong", "Yoohyeon", "Dami", "Gahyeon"],
    "Dreamnote": ["Boni", "Youi", "Lara", "Miso", "Sumin", "Eunjo", "Habin", "Hanbyeol"],
    "Everglow": ["E:U", "Sihyeon", "Mia", "Onda", "Aisha", "Yiren"],
    "EXID": ["Solji", "Hyeyeon", "Uji", "LE", "Hani", "Dahye", "Hyerin", "Junghwa"],
    "f(x)": ["Victoria", "Amber", "Luna", "Sulli†", "Krystal"],
    "FANATICS": ["Doi", "Sika", "Chaelin", "Chiayi", "Via", "Yoonhye", "Rayeon", "Doah"],
    "Favorite": ["Saebom", "Seoyeon", "Gaeul", "Sugyeong", "Jeonghee", "Ahra"],
    "Fiestar": ["Cao Lu", "Jei", "Linzy", "Hyemi", "Yezi"],
    "FIFTY FIFTY": ["Keena", "Saena", "Sio", "Aran"],
    "fromis_9": ["Saerom", "Hayoung", "Gyuri", "Jiwon", "Jisun", "Seoyeon", "Chaeyoung", "Nakyung", "Jiheon"],
    "G-reyish": ["Hyunseo", "Shinyoung", "Yena", "Yeso"],
    "Gate9": ["Haeyeon", "Taera", "Yeori", "Haru", "Gaga", "Kady", "Juju", "Yoon", "Vivian"],
    "Geenius": ["Yeyoung", "Sion", "Mika", "Zoe", "Andamiro"],
    "Gfriend": ["Sowon", "Yerin", "Eunha", "Yuju", "SinB", "Umji"],
    "Girl's Day": ["Sojin", "Jisun", "Yura", "Minah", "Hyeri"],
    "Girlkind": ["Medic Jin", "JK", "Xeheun", "Sun J", "Ellyn"],
    "Girls Alert": ["Satbyeol"],
    "Girls' World": ["Kyrin", "Windy", "A-ra", "Hari"],
    "Good Day": ["Heejin", "I.L", "Liv", "Chaesol", "Yunseul", "Jeewon", "Yeah", "Sunn", "Bomin", "Belle"],
    "Gugudan": ["Mimi", "Hana", "Haebin", "Nayoung", "Sejeong", "Sally", "Soyee", "Mina", "Hyeyeon"],
    "GWSN": ["Miya", "Seokyoung", "Seoryoung", "Anne", "Minju", "Soso", "Lena"],
    "H.U.B": ["Rui", "Gracie", "Yuem", "Hyosun", "Keina"],
    "H1-KEY": ["Sitala", "Seoi", "Riina", "Hwiseo", "Yel"],
    "Hashtag": ["Hyunji", "Sua", "Dajeong", "Seungmin", "Subin", "Sojin", "Aeji"],
    "Hearts2Hearts": ["Jiwoo", "Carmen", "Yuha", "Stella", "Juun", "A-na", "Ian", "Ye-on"],
    "Hello Venus": ["Alice", "Nara", "Yoonjo", "Lime", "Seoyoung", "Yooyoung", "Yeoreum"],
    "Hi-L": ["Lee Jin", "Soojung", "Dakyung", "JooA", "Hayun", "Yeseul"],
    "Highteen": ["Eunjin", "Hyejoo", "Hyebin", "Sea"],
    "Hinapia": ["Roa", "Yuha", "Eunwoo", "Rena", "Bada"],
    "Ho1iday": ["Cheongeum", "Saebyeok", "Heejoo", "Haru", "Dany"],
    "Honey Popcorn": ["Moko", "Yua", "Miko"],
    "HOT ISSUE": ["Mayna", "Nahyun", "Hyeongshin", "Dana", "Yewon", "Yebin", "Dain"],
    "I.B.I": ["Lee Haein", "Sohee", "Lee Suhyun", "Han Hyeri"],
    "I.O.I": ["Chungha", "Sejeong", "Chaeyeon", "Sohye", "Yeonjung", "Mina", "Somi"],
    "ICHILLIN'": ["Jiyoon", "E.Ji", "Jackie", "Joonie", "Chaerin", "Sohee", "Yeju", "Chowon"],
    "ILLIT": ["Yunah", "Minju", "Moka", "Wonhee", "Iroha"],
    "ILUV": ["Seoyoon", "Sang", "Jiwon"],
    "ILY:1": ["Hana", "Ara", "Rona", "Ririka", "Nayu", "Elva"],
    "IRRIS": ["I.L", "Liv", "Yunseul", "Nina"],
    "ITZY": ["Yeji", "Lia", "Ryujin", "Chaeryeong", "Yuna"],
    "IVE": ["Gaeul", "Yujin", "Rei", "Wonyoung", "Liz", "Leeseo"],
    "IZ*ONE": ["Eunbi", "Sakura", "Hyewon", "Yena", "Chaeyeon", "Chaewon", "Minjoo", "Nako", "Hitomi", "Yuri", "Yujin", "Wonyoung"],
    "KARA": ["Gyuri", "Seungyeon", "Hara†", "Nicole", "Jiyoung", "Youngji"],
    "KARD": ["Somin", "Jiwoo"],
    "KEEMBO": ["Boa", "Bohyung"],
    "KELT9b": ["Suhyun", "Euijeong", "Lua", "Minju", "Youngjae", "Chaerin"],
    "Kep1er": ["Yujin", "XiaoTing", "Chaehyun", "Dayen", "Hikaru", "Bahiyyih", "Youngeun"],
    "KISS OF LIFE": ["Julie", "Natty", "Belle", "Haneul"],
    "Kiwi Band": ["Hyosun"],
    "LABOUM": ["Yujeong", "Soyeon", "ZN", "Haein", "Solbin", "Yulhee"],
    "Ladies' Code": ["Ashley", "Sojung", "Zuny"],
    "Lapillus": ["Chanty", "Shana", "Yue", "Bessie", "Seowon", "Haeun"],
    "LE SSERAFIM": ["Sakura", "Chaewon", "Yunjin", "Kazuha", "Garam", "Eunchae"],
    "LIGHTSUM": ["Sangah", "Chowon", "Nayoung", "Hina", "Juhyeon", "Yujeong", "Huiyeon", "Jian"],
    "Lip Bubble": ["EunB"],
    "LOONA": ["Vivi", "Yves", "JinSoul", "Haseul", "Kim Lip", "Chuu", "Heejin", "Hyunjin", "Gowon", "Choerry", "Hyeju", "Yeojin"],
    "Loossemble": ["Vivi", "Hyunjin", "Gowon", "Hyeju", "Yeojin"],
    "Lovelyz": ["Babysoul", "Jiae", "Jisoo", "Mijoo", "Kei", "JIN", "Sujeong", "Yein"],
    "LUNARSOLAR": ["Eseo", "Taeryeong", "Jian", "Yuuri"],
    "Lusty": ["Harin", "Jinhui", "Isol", "Yoonji", "Yeryung"],
    "Madein": ["Mashiro", "MiU", "Suhye", "Yeseo", "Gaeun", "Serina", "Nagomi"],
    "MAJORS": ["Vita", "Ida", "Aki", "Bian", "Suzy", "Shinye"],
    "Maka Maka": ["Heesu", "Dia", "Chaewon", "Daseul", "EunB"],
    "Mamamoo": ["Solar", "Moonbyul", "Wheein", "Hwasa"],
    "Matilda": ["Haena", "Dan-a", "Semmi", "Saebyeol"],
    "MELODYDAY": ["Yeoeun", "Yoomin", "Yein", "Chahee"],
    "MIDNIGHT": ["Dabi"],
    "mimiirose": ["Hyori", "Yeonjae", "Yewon", "Jia", "Yunju"],
    "Minx": ["Jiu", "Sua", "Siyeon", "Yoohyeon", "Dami"],
    "miss A": ["Fei", "Jia", "Min", "Suzy"],
    "MIXX": ["Hanna", "Henny", "Heeyu", "Mia", "Arie", "Liyah"],
    "MOMOLAND": ["Hyebin", "Yeonwoo", "Jane", "Taeha", "Nayun", "Daisy", "Joo E", "AhIn", "Nancy"],
    "MyB": ["Heejoo", "Haru", "Moonhee", "Hayoon"],
    "N-Bulance": ["Rui"],
    "NATURE": ["Aurora", "Saebom", "Lu", "Chaebin", "Gaga", "Haru", "Uchae", "Sunshine"],
    "Nature": ["Sohee", "Loha"],
    "NeonPunch": ["Dayeon", "Hajeong", "Terry", "Dohee", "Baekah", "Arang", "May", "Iaan"],
    "New F.O": ["Jisun"],
    "NewJeans": ["Minji", "Hanni", "Danielle", "Haerin", "Hyein"],
    "NMIXX": ["Lily", "Haewon", "Sullyoon", "Jinni", "Bae", "Jiwoo", "Kyujin"],
    "Oh My Girl": ["Hyojung", "JinE", "Mimi", "Yooa", "Seunghee", "Jiho", "Yubin", "Arin"],
    "P.O.P": ["Ahyung", "Miso", "Seol", "Haeri", "Yeonjoo", "Yeonha"],
    "Pink Fantasy": ["Aini", "Seea", "Yechan", "Daewang Nim", "Sanga", "Yubin", "Harin", "Momoka", "Arang", "Miku", "Heesun"],
    "Pixy": ["Ella", "Lola", "Satbyeol", "Dia", "Sua", "Dajeong", "Rinji"],
    "Playback": ["Yunji", "Hayoung", "Yujin", "Woolim", "Eunjin"],
    "PRECIOUS": ["EunB", "Jihyo", "Hanwoom", "Lee Soo", "Hanbyul"],
    "PRIMROSE": ["Rainie", "Yeum", "Nahyun", "Ruby", "Hayun"],
    "Pristin": ["Nayoung", "Roa", "Yuha", "Eunwoo", "Rena", "Kyulkyung", "Yehana", "Sungyeon", "Xiyeon", "Kyla"],
    "Pungdeng-E": ["Red", "Yellow", "Blue"],
    "Puretty": ["Chaekyung"],
    "Purple Kiss": ["Jieun", "Goeun", "Dosie", "Ireh", "Yuki", "Chaein", "Swan"],
    "Purplebeck": ["Yerim", "Yeowool", "Layeon", "Mini", "Seyeon"],
    "Queenz Eye": ["Hannah", "Narin", "Wonchae", "Ahyoon", "Damin", "Jenna"],
    "Rainbow": ["Woori", "Seungah", "Jaekyung", "Noeul", "Yoonhye", "Jisook", "Hyunyoung"],
    "Red Velvet": ["Irene", "Seulgi", "Wendy", "Joy", "Yeri"],
    "RedSquare": ["Lina", "I.L", "Liv", "Yunseul", "Bomin"],
    "RESCENE": ["Woni", "Liv", "Minami", "May", "Zena"],
    "Rocket Punch": ["Juri", "Yeonhee", "Suyun", "Yunkyung", "Sohee", "Dahyun"],
    "Rockit Girl": ["Della", "Han Leeseul"],
    "Rose Finger": ["Hyebin", "Areum", "Segye"],
    "S#aFLA": ["Suhyeon", "Jisun", "Yujin", "Seulgi"],
    "S.E.T": ["Jian"],
    "Saturday": ["Haneul", "Juyeon", "Yuki", "Ayeon", "Minseo"],
    "SECRET NUMBER": ["Lea", "Dita", "Jinny", "Minji", "Soodam", "Zuu", "Denise"],
    "SECRET": ["Hyosung", "Hana", "Jieun", "Sunhwa"],
    "SISTAR": ["Bora", "Hyorin", "Soyou", "Dasom"],
    "Skarf": ["Lea"],
    "SNSD": ["Taeyeon", "Jessica", "Sunny", "Tiffany", "Hyoyeon", "Yuri", "Sooyoung", "Yoona", "Seohyun"],
    "Soloist / NA": ["Ailee", "Aini", "AleXa", "Arang", "Bekah", "BIBI", "BoA", "Boram", "Cheng Xiao", "Chi.u", "Choa", "Chungha", "Chuu", "Dahye", "Dain", "Daisy", "Denise", "Dohee", "Elkie", "Ella", "Euaerin", "Eunjin", "Eyedi", "G.NA", "Gaeun", "Gaga", "Garam", "Gyuri", "Habin", "Hajeong", "Hanbyeol", "Hayun", "Henny", "Huiyeon", "Hyeran", "Hyeyeon", "Hyuna", "Hyunseo", "I", "IU", "Jenna", "Jenny", "Jessica", "Jian", "Jieun", "Jiho", "Jimin", "JinE", "Jinju", "Jinni", "Jiyoon", "Jiyul", "JOO", "Jooyeon", "Judy", "Jungah", "Kahi", "Kiara", "Kokoro", "Kriesha Chu", "Lin Lin", "May", "Meiqi", "Mina", "Minha", "Minjung", "Nada", "Naeun", "Roa", "Sanga", "Satbyeol", "Sika", "Sitala", "Sohee", "Sohye", "Somi", "Songyee", "Soojin", "Soyeon", "Soyoung", "Sulli†", "Sunhwa", "Sunn", "Taeha", "Terry", "Uee", "Uji", "Viki", "Xuanyi", "Yeah", "Yeonwoo", "Yeum", "Yoojin", "Yookyung", "Youngheun", "Yubin", "Yujeong", "Yulhee", "Yves"],
    "Sonamoo": ["Sumin", "Minjae", "D.ana", "Nahyun", "Euijin", "High.D", "New Sun"],
    "SPICA": ["Sihyun", "Boa", "Narae", "Jiwon", "Bohyung"],
    "STAYC": ["Sumin", "Sieun", "Isa", "Seeun", "Yoon", "J"],
    "Stellar": ["Gayoung", "Minhee", "Hyeoeun", "Jeonyul"],
    "T-ara": ["Boram", "Qri", "Soyeon", "Eunjung", "Hyomin", "Jiyeon"],
    "Tahiti": ["Miso", "Minjae", "Jerrry", "Jisoo", "Ari"],
    "The Ark": ["Suji"],
    "Tiny-G": ["Mint", "Dohee", "J.Min", "Myungji"],
    "TRACER": ["Alice", "Genie", "Sowon", "Yubeen"],
    "TRI.BE": ["SongSun", "Kelly", "Jinha", "Hyunbin", "Jia", "Soeun", "Mire"],
    "tripleS": ["Yooyeon", "Mayu", "Xinyu", "Nakyung", "Sohyun", "Dahyun", "Nien", "Seoyeon", "Kotone", "Chaeyeon", "Yubin", "Jiwoo", "Kaede", "Shion", "Lynn", "Hyerin", "Hayeon", "Soomin", "Yeonji", "Joobin"],
    "Twice": ["Nayeon", "Jeongyeon", "Momo", "Sana", "Jihyo", "Mina", "Dahyun", "Chaeyoung", "Tzuyu"],
    "Two X": ["Jiyou", "Eun", "Surin", "Eunyoung"],
    "UNI.T": ["Jiwon", "Yoonjo", "NC.A", "Hyunjoo", "Suji"],
    "UNIS": ["Nana", "Gehlee", "Kotoko", "Yunha", "Elisia", "Yoona", "Seowon"],
    "VIVIZ": ["Eunha", "SinB", "Umji"],
    "Wassup": ["Jinju", "Dain", "Nada", "Nari", "Jiae", "Sujin", "Woojoo"],
    "We;Na": ["Doa", "Euna", "Yeonseo", "Wony"],
    "Weeekly": ["Soojin", "Jiyoon", "Monday", "Soeun", "Jaehee", "Jihan", "Zoa"],
    "Weki Meki": ["Suyeon", "Elly", "Yoojung", "Doyeon", "Sei", "Lua", "Rina", "Lucy"],
    "WJSN": ["Seola", "Xuanyi", "Bona", "Exy", "Soobin", "Luda", "Dawon", "Eunseo", "Cheng Xiao", "Meiqi", "Yeoreum", "Dayoung", "Yeonjung"],
    "Wonder Girls": ["Yubin", "Yenny", "Sunmi", "HyunA", "Hyerim"],
    "woo!ah!": ["Nana", "Wooyeon", "Sora", "Lucy", "Minseo", "Songyee"],
    "X:IN": ["Roa", "Chi.u", "E.sha", "Nizz", "Nova", "Hannah", "Aria"],
    "XUM": ["Dayeon", "Baekah", "Iaan"],
    "YOUNG POSSE": ["Sunhye", "Yeonjung", "Jiana", "Doeun", "Jieun"]
    };

    const CONFIG = {
        //NAMING_FORMAT: '{member} {random}.{ext}', // Allowed vars: {group}, {member}, {random}, {ext}
    ...
    const SORTED_GROUP_NAMES = Object.keys(KPOP_DATABASE).sort((a, b) => a.localeCompare(b));
    ...
    const UI = {
            ...
            GM_addStyle(`
                ...
                @media (max-width: 1100px) {
                    .${CONFIG.UI_PREFIX}-layout {
                        ...
                        overflow-y: auto; height: 100vh; max-height: 100vh;
        ...
        createMainPanel() {
            ...
            if (this.currentView === 'groups') {
                SORTED_GROUP_NAMES.forEach(gName => {
                    ...
                    KPOP_DATABASE[gName].forEach(mName => {
                ...
                KPOP_DATABASE[this.selectedGroup].forEach(mName => {
                    const mBtn = document.createElement('div');
                    mBtn.className = `${CONFIG.UI_PREFIX}-item`;
                    mBtn.dataset.name = mName.toLowerCase();
    ...
    const App = {
        init() {
            ...
            UI.injectFAB();
            this.bindEvents();
            Logger.info('Initialized K-Pop Media Downloader v4.1');
        },
